...
def main(opts):
    ...
    """
    # test the logging
    logging.info("%s : This is an INFO message")
    logging.error("%s : This is an ERROR message")
    logging.warning("%s : This is a WARNING message")
    logging.critical("%s : This is a CRITICAL message")
    logging.debug("%s : This is a DEBUG message")

    try:
        print("I parsed the string '%s' as your desired samplefileoption" % opts.samplefileoption)
